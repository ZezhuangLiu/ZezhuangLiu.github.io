...
The homepage is a static GitHub Pages site for prospective PhD applications. It summarizes research interests, selected publications, technical skills, independent project experience, honors, CVs, and contact information.
...
- `assets/cv-zezhuang-liu.pdf` - English CV
...
Edit `index.html` for content changes, replace CVs or the photo in `assets/`, then run:
